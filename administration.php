...
//$delete_user=filter_input(INPUT_POST, 'delete_user', FILTER_SANITIZE_SPECIAL_CHARS);// передаёт ид удаляемой формы
//$update_user=filter_input(INPUT_POST, 'update_user', FILTER_SANITIZE_SPECIAL_CHARS); // лучше использовать id_user
...
//    }   
//}
$smarty->assign('title', $administration_view->title);
