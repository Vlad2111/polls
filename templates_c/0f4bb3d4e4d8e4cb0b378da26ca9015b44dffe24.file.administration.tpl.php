<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-29 00:43:41
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array('new_user', null, null); ob_start(); ?>
...
" title='При удалении пользователя, также удалить вся зависимая информация представленная внизу в Дополнительной информации'>Удалить пользователя</button>
...
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp2=='table_quizs') {?>
                ...
                <?php } else {?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['view_admin']->value;?>
<?php $_tmp3=ob_get_clean();?><?php if ($_tmp3=='new_user') {?>
                    <?php echo Smarty::$_smarty_vars['capture']['new_user'];?>

                <?php } else {?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['view_admin']->value;?>
<?php $_tmp4=ob_get_clean();?><?php if ($_tmp4=='edit_user') {?>
                    <?php echo Smarty::$_smarty_vars['capture']['edit_user'];?>

                <?php } else {?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['view_admin']->value;?>
<?php $_tmp5=ob_get_clean();?><?php if ($_tmp5=='new_internal_user') {?>
                    <?php echo Smarty::$_smarty_vars['capture']['new_internal_user'];?>

                <?php } else {?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['view_admin']->value;?>
<?php $_tmp6=ob_get_clean();?><?php if ($_tmp6=='new_ldap_user') {?>
